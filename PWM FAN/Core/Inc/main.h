...
#define FAN_A2_SENSER_EXTI_IRQn EXTI2_IRQn
#define FNA_B1_SENSOR_Pin GPIO_PIN_5
#define FNA_B1_SENSOR_GPIO_Port GPIOE
#define FNA_B1_SENSOR_EXTI_IRQn EXTI9_5_IRQn
...
#define FAN_A1_SENSER_EXTI_IRQn EXTI3_IRQn
