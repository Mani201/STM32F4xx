...
/* Private defines -----------------------------------------------------------*/
#define FAN_A2_SENSOR_Pin GPIO_PIN_2
#define FAN_A2_SENSOR_GPIO_Port GPIOE
#define FAN_A2_SENSOR_EXTI_IRQn EXTI2_IRQn
#define FAN_B1_SENSOR_Pin GPIO_PIN_5
#define FAN_B1_SENSOR_GPIO_Port GPIOE
#define FAN_B1_SENSOR_EXTI_IRQn EXTI9_5_IRQn
...
#define FAN_A1_SENSOR_Pin GPIO_PIN_3
#define FAN_A1_SENSOR_GPIO_Port GPIOD
#define FAN_A1_SENSOR_EXTI_IRQn EXTI3_IRQn
#define WIZNET_RESET_Pin GPIO_PIN_11
#define WIZNET_RESET_GPIO_Port GPIOG
#define FAN_B2_SENSOR_Pin GPIO_PIN_13
#define FAN_B2_SENSOR_GPIO_Port GPIOG
#define FAN_B2_SENSOR_EXTI_IRQn EXTI15_10_IRQn
